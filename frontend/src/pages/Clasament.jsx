...
const Clasament = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <NavBar />
      <div className="pt-20 px-4 md:px-12 pb-6 max-w-3xl mx-auto">
        <h1 className="font-display italic text-3xl mb-1 flex items-center gap-3">
          <Trophy className="h-7 w-7 text-[#ffcc00]" /> Clasament
        </h1>
        <p className="text-white/50 text-sm mb-4">Top 10 utilizatori după timpul petrecut online în platformă.</p>
        ...
        {/* Top 10 */}
        <h2 className="font-display text-lg mb-2">Top 10</h2>
