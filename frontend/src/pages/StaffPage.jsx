...
export default function StaffPage() {
  ...
  const [appState, setAppState] = useState(null); // null = not loaded; {application: ...}
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(
        getErrorMessage(err, "Nu am putut trimite aplicația. Verifică câmpurile.")
      );
    } finally {
      setSubmitting(false);
    }
    ...
    <PublicLayout>
      <section className="relative noise-overlay">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-16">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[11px] uppercase tracking-[0.18em] font-bold text-amber-300 mb-4">
            ...
            <p className="mt-5 text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Cartoonix este o comunitate construită în jurul creativității,
              distracției și respectului. Pe măsură ce platforma crește, avem nevoie
              de oameni implicați care să ne ajute să menținem un mediu plăcut și
              activ pentru toți utilizatorii.
            </p>
          </motion.div>

          {/* Status card OR intro+form */}
          {application && !canReapply ? (
            ...
            <>
                    ...
                    >
                      <div className="flex items-center gap-2.5 mb-3">
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg,#ff7a1a,#facc15)",
                            color: "#0a0a0a",
                          }}
                        >
              ...
              <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 px-5 py-3 text-sm text-amber-100/90 mb-8 italic">
                Nu căutăm perfecțiune — căutăm oameni serioși, consecvenți și de
                încredere.
              </div>
              ...
              {!user ? (
                ...
                >
                  ...
                  <Section
                    ...
                    subtitle="Cine ești și cât de des te găsim aici."
                  >
                    ...
                    <Field
                      label="De cât timp folosești platforma?"
                      required
                      testId="field-used-since"
                    >
                      <Input
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {ACTIVITY_OPTIONS.map((opt) => (
                          <button
                            ...
                            key={opt}
                            onClick={() =>
                              setForm((f) => ({ ...f, activity_level: opt }))
                            }
                  ...
                  <Section
                    idx={2}
                    title="Motivație"
                    subtitle="De ce vrei să intri în staff? Răspunde din suflet."
                  >
                  ...
                  <Section
                    idx={3}
                    title="Experiență"
                    subtitle="Ce ai mai făcut și cum gândești în general."
                  >
                    <Field
                  ...
                  >
                    <Field
                      label="Un utilizator spammează în chat. Ce faci?"
                      required
                      testId="field-spam"
                    >
                      <Textarea
                    ...
                    <Field
                      label="Un prieten de-al tău încalcă regulile. Ce faci?"
                      required
                      testId="field-friend"
                    >
                      <Textarea
                  ...
                  <Section
                    ...
                    subtitle="Cât poți fi prezent ca staff."
                  >
                    <Field
                      label="Câte ore pe zi poți fi activ ca staff?"
                      required
                      testId="field-hours"
                    >
                      <Input
                    ...
                    <Field
                      label="În ce intervale orare?"
                      required
                      testId="field-intervals"
                    >
                      <Input
                  ...
                  <Section
                    idx={6}
                    title="Extra (opțional)"
                    subtitle="Spune-ne dacă ai idei de îmbunătățire."
                  >
                    <Field
                      label="Ce ai îmbunătăți la Cartoonix?"
                      testId="field-improvements"
                    >
                      <Textarea
                        rows={4}
