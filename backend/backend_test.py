...
BASE_URL = "https://stripe-500-error.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://stripe-500-error.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
