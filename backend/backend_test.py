...
BASE_URL = "https://brand-showcase-193.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://brand-showcase-193.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
