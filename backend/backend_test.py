...
BASE_URL = "https://cartoonix-debug.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://cartoonix-debug.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
