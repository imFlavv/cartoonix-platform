...
BASE_URL = "https://payment-sync-issue-1.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://payment-sync-issue-1.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
