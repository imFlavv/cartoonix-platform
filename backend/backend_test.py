...
BASE_URL = "https://upgrade-hub-29.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://upgrade-hub-29.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
