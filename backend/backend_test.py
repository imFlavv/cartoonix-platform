...
BASE_URL = "https://admin-user-tracker.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://admin-user-tracker.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
