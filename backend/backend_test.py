...
BASE_URL = "https://downtime-notice.preview.emergentagent.com/api"
...
class CartoonixAPITester:
    ...
    def test_static_avatar_file(self):
        ...
        resp = requests.get(f"https://downtime-notice.preview.emergentagent.com/uploads/avatars/hero_boy.jpg")
